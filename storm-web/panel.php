    ...
    <div class="main-content">
        <div id="content-area" class="glass-container">
            <div class="default-content">
                <h1 class="glitch" data-text="HackNet">LETCHU-SET</h1>
                <pp>Welcome to the LETCHU-SET  Next-Gen Social Hacking. </p> <p>  Select an operation from the sidebar to begin.</p>
                <p><strong>Warning:</strong> Unauthorized access is prohibited. Use at your own risk.</p>
                <p><strong>Developed by:</strong> LETCHU_PKT </p>
            </div>
        </div>
